...
function uvPyramid(size, sides, height){
   ...
   var angle = (Math.PI * 2) / sides;
        for (var i = 0; i <= sides; i++) {
            var x = (Math.cos(i * angle)/2);
            var y = (Math.sin(i * angle)/2);
            vertices[i * 3] = 0;
            vertices[i * 3 + 1] = x;
            vertices[i * 3 + 2] = y;            
        }
   ...
   for (var i = 0; i <= sides; i++) {
       ...
       if(i>0){
            vertices[cnt + i * 9] = 0;
            vertices[cnt + i * 9 + 1] = 0;
            vertices[cnt + i * 9 + 2] = height/2;
            vertices[cnt + i * 9 + 3] = x;
            vertices[cnt + i * 9 + 4] = y;
            vertices[cnt + i * 9 + 5] = 0;
            vertices[cnt + i * 9 + 6] = prevX;
            vertices[cnt + i * 9 + 7] = prevY;
            vertices[cnt + i * 9 + 8] = 0;            
       }
       prevX = x;
       prevY = y;
   }
